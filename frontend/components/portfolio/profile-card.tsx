...
// Tarjeta de presentación del desarrollador — réplica exacta de la ProfileCard
// del portafolio de Esteban (Uiverse/ReactBits "ProfileCard"). Convertida a TSX.
        ...
        <div className="pc-inside">
          ...
          <div className="pc-content pc-avatar-content">
            {avatarUrl ? (
              ...
              <div className="avatar pc-avatar-fallback" aria-hidden="true">{initial}</div>
            )}
            {showUserInfo && (
                ...
                <div className="pc-user-details">
                  <div className="pc-mini-avatar">
                    {(miniAvatarUrl || avatarUrl) ? (
                      ...
                      <div className="pc-avatar-fallback" style={{ width: '100%', height: '100%' }} aria-hidden="true">{initial}</div>
                    )}
                  </div>
